...
<html lang="ja">
  ...
  <body>
    <main class="app-shell">
      <header class="topbar">
        <div>
          <p class="eyebrow">ローカル対戦プロトタイプ</p>
          <h1>バディファイト試作アプリ</h1>
        </div>
        <div class="toolbar" aria-label="ゲーム操作">
          ...
          <label class="deck-picker">
            <span>CPU</span>
            <select id="cpuModeSelect" aria-label="プレイヤー2をCPUにする" title="次の新規ゲームからP2をCPUが操作します">
              <option value="off">オフ</option>
              <option value="on">P2をCPU</option>
            </select>
          </label>
          <label class="deck-picker">
            <span>先攻</span>
            <select id="cpuFirstSeat" aria-label="先攻の席（CPU対戦時）" title="CPU対戦時の先攻（新規ゲームで適用）">
              <option value="random">ランダム</option>
              <option value="0">プレイヤー1</option>
              <option value="1">プレイヤー2(CPU)</option>
            </select>
          </label>
          <div id="accountControl" class="account-control-slot"></div>
          <a class="toolbar-link" href="builder.html">デッキ構築</a>
          <a class="toolbar-link" href="gallery.html">カード図鑑</a>
          <a class="toolbar-link" href="play.html">ネット対戦</a>
          <button id="newGameButton" type="button" title="新しいゲーム">新規</button>
          <button id="matchHistoryButton" type="button" title="デッキ別の勝敗・勝率と直近の対戦履歴">戦績</button>
    ...
    <dialog id="matchHistoryDialog" class="match-history-dialog" aria-label="戦績・対戦履歴">
      <div class="dialog-content">
        <header>
          <h2>戦績・対戦履歴</h2>
          <button id="closeMatchHistoryButton" type="button" title="閉じる">閉じる</button>
        </header>
        <p id="matchHistoryEmpty" class="match-history-empty">まだ対戦の記録がありません。ゲームを終局まで進めると、この端末に戦績が残ります。</p>
        <section class="match-history-section">
          <h3>デッキ別 勝率</h3>
          <div class="match-table-scroll">
            <table class="match-stats-table">
              <thead>
                <tr><th>デッキ</th><th class="match-num">勝</th><th class="match-num">敗</th><th class="match-num">勝率</th></tr>
              </thead>
        ...
        <section class="match-history-section">
          <h3>直近の対戦</h3>
          <ul id="matchRecentBody" class="match-recent-list"></ul>
        </section>
      </div>
    </dialog>
