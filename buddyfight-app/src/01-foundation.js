...
const elements = {
  ...
  soulDialog: document.querySelector("#soulDialog"),
  soulDialogTitle: document.querySelector("#soulDialogTitle"),
  soulDialogLead: document.querySelector("#soulDialogLead"),
  soulDialogList: document.querySelector("#soulDialogList"),
  closeDropDialogButton: document.querySelector("#closeDropDialogButton"),
  closeSoulDialogButton: document.querySelector("#closeSoulDialogButton"),
